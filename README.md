...
- My first project is called [Pixelator Alligator](https://dannyboi-john.github.io/Pixelator_Alligator/). In essence, it takes a user-submitted image, and pixelates that image based on your specifications. I had initially designed this application to help with my crochet projects, but have since found its utility to be extensible to all kinds of crafts such as perler beads, embroidery, and of course, pixel art!

- My most recent project, [The Great and Powerful TarotBot](http://tarotbot.me) was an immense labour of love, and was a blast to throw together. Who doesn't love a good ol' card reading? Simply type in your query, if you have a specific question you'd like to focus on, (or leave blank for a general reading) and let The Spirits (<sub>*cough* OpenAI</sub>) unveil their mystical insights!
